...
class DataAggregator:
    ...
    def load_all(self, verbose=False):
        ...
        min_dt = datetime.datetime(2000,1,1,0,0,0) if self.mindataset is None else datetime.strptime(self.mindataset, DATETIME_FMT)
        max_dt = datetime.datetime(2100,1,1,0,0,0) if self.maxdataset is None else datetime.strptime(self.mindataset, DATETIME_FMT)
